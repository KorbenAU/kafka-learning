...
kafka-consumer-groups --bootstrap-server 192.168.1.101:29092,192.168.1.101:39092 --group my-first-application --reset-offsets --to-earliest

# execute flag is needed
kafka-consumer-groups --bootstrap-server 192.168.1.101:29092,192.168.1.101:39092 --group my-first-application --reset-offsets --to-earliest --execute

# topic flag is also needed
kafka-consumer-groups --bootstrap-server 192.168.1.101:29092,192.168.1.101:39092 --group my-first-application --reset-offsets --to-earliest --execute --topic first_topic
...
kafka-consumer-groups --bootstrap-server 192.168.1.101:29092,192.168.1.101:39092 --group my-first-application --reset-offsets --shift-by 2 --execute --topic first_topic
